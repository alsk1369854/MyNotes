...
path = os.path.join(os.path.dirname(os.getcwd()),'image_folder')
...
encodeListKnown = np.load('model/encodeListKnown.npy')
# encodeListKnown = np.array(encodeListKnown)
# with open('model/encodeListKnown.npy','wb')as f:
#     np.save(f, encodeListKnown)
